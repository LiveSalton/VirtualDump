...
import com.salton123.hook.ClassLoaderHook;
...
public final class VClientImpl extends IVClient.Stub {
        ...
        if (ActivityThread.performNewIntents != null) {
            ...
            if (BuildCompat.isQ()) {
                ActivityThread.handleNewIntent
                        .call(VirtualCore.mainThread(), data.token, Collections.singletonList(intent));
            } else {
    ...
    private void bindApplicationNoCheck(String packageName, String processName, ConditionVariable lock) {
        ...
        data.providers =
                VPackageManager.get().queryContentProviders(processName, getVUid(), PackageManager.GET_META_DATA);
        ...
        try {
            ...
            if (!mInstrumentation.onException(mInitialApplication, e)) {
                ...
                throw new RuntimeException(
                        "Unable to create application " + (mInitialApplication == null ? " [null application] " :
    ...
    private void startIOUniformer() {
        ...
        String userLibPath =
                new File(VEnvironment.getUserSystemDirectory(userId), info.packageName + "/lib").getAbsolutePath();
    ...
    private Context createPackageContext(String packageName) {
        try {
            ...
            return hostContext
                    .createPackageContext(packageName, Context.CONTEXT_INCLUDE_CODE | Context.CONTEXT_IGNORE_SECURITY);
